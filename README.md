...
### Challenges
- I had lot of system errors running the application on my end which delayed the development process. This may be due to my system venv environment or application not setup correctly. I will still need help with that.
