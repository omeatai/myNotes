...
<div class="right_col" role="main">
  ...
  <div class="x_content">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      ...
      <div class="row">
        <form class="form-horizontal form-label-left form-signin" id="demo-form2" method="POST" action="{{ route('post_changeinfo') }}" data-parsley-validate enctype="multipart/form-data">
         @csrf
        ...
        <div class="row form-group">
          ...
          <div class="col-md-3 col-sm-3 col-xs-3">
            <label class="control-label col-xs-12" for="id" >ID: <span class="required">*</span></label>
          </div>
          <div class="col-md-9 col-sm-9 col-xs-9">
            <input class="form-control" name="id" id="id" type="text" placeholder="{{$id}}" value="<?php
                $num = $id;
        ...
        <div class="row form-group">
          <div class="col-md-3 col-sm-3 col-xs-3">
            <label class="control-label col-xs-12" for="pin" >PIN: <span class="required">*</span></label>
          </div>
          <div class="col-md-9 col-sm-9 col-xs-9">
        ...
        <div class="row form-group">
          <div class="col-md-3 col-sm-3 col-xs-3">
            <label class="control-label col-xs-12" for="title" >TITLE: <span class="required">*</span></label>
          </div>
          <div class="col-md-9 col-sm-9 col-xs-9">
        ...
        <div class="row form-group">
          <div class="col-md-3 col-sm-3 col-xs-3">
            <label class="control-label col-xs-12" for="firstname" >FIRSTNAME: <span class="required">*</span></label>
          </div>
          <div class="col-md-9 col-sm-9 col-xs-9">
            <input class="form-control" name="firstname" id="firstname" type="text" placeholder="{{$firstname}}" value={{$firstname}}>
          </div>
        </div>

        <div class="row form-group">
          <div class="col-md-3 col-sm-3 col-xs-3">
            <label class="control-label col-xs-12" for="lastname" >LASTNAME: <span class="required">*</span></label>
          </div>
          <div class="col-md-9 col-sm-9 col-xs-9">
            <input class="form-control" name="lastname" id="lastname" type="text" placeholder="{{$lastname}}" value={{$lastname}} >
          </div>
        </div>

        <div class="row form-group">
          <div class="col-md-3 col-sm-3 col-xs-3">
            <label class="control-label col-xs-12" for="phone" >PHONE: <span class="required">*</span></label>
          </div>
          <div class="col-md-9 col-sm-9 col-xs-9">
            <input class="form-control" name="phone" id="phone" type="text" placeholder="{{$phone}}" value={{$phone}}>
          </div>
        </div>

        <div class="row form-group">
          <div class="col-md-3 col-sm-3 col-xs-3">
            <label class="control-label col-xs-12" for="email" >EMAIL: <span class="required">*</span></label>
          </div>
          <div class="col-md-9 col-sm-9 col-xs-9">
        ...
        <div class="row form-group">
            <div class="col-md-3 col-sm-3 col-xs-3">
                <label class="control-label col-xs-12" for="sex" >SEX: <span class="required">*</span></label>
            </div>
            <div class="col-md-9 col-sm-9 col-xs-9">
        ...
        <div class="row form-group">
          <div class="col-md-3 col-sm-3 col-xs-3">
              <label class="control-label col-xs-12" for="location" >Location: <span class="required">*</span></label>
          </div>
          <div class="col-md-9 col-sm-9 col-xs-9">
        ...
        <div class="row form-group">
            <div class="col-md-3 col-sm-3 col-xs-3">
                <label class="control-label col-xs-12" for="anglican" >ARE YOU AN ANGLICAN?: <span class="required">*</span></label>
            </div>
            <div class="col-md-9 col-sm-9 col-xs-9">
        ...
        <div class="row form-group">
            <div class="col-md-3 col-sm-3 col-xs-3">
                <label class="control-label col-xs-12" for="province" >PROVINCE: <span class="required">*</span></label>
            </div>
            <div class="col-md-9 col-sm-9 col-xs-9">
        ...
        <div class="row form-group">
            <div class="col-md-3 col-sm-3 col-xs-3">
                <label class="control-label col-xs-12" for="diocese" >DIOCESE: <span class="required">*</span></label>
            </div>
            <div class="col-md-9 col-sm-9 col-xs-9">
        ...
        <div class="row form-group">
            <div class="col-md-3 col-sm-3 col-xs-3">
                <label class="control-label col-xs-12" for="designation" >DESIGNATION: <span class="required">*</span></label>
            </div>
            <div class="col-md-9 col-sm-9 col-xs-9">
        ...
        <div class="row form-group">
            <div class="col-md-3 col-sm-3 col-xs-3">
                <label class="control-label col-xs-12" for="church" >CHURCH: <span class="required">*</span></label>
            </div>
            <div class="col-md-9 col-sm-9 col-xs-9">
            ...
            <button type="submit" class="btn btn-block btn-success">CONFIRM CHANGE</button>
            <button onclick="window.location = 'secretariat';" type="button" class="btn btn-block btn-danger">GO BACK TO DASHBOARD</button>
