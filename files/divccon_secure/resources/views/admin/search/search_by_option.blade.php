  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3>SEARCH BY OPTION: <small></small></h3>
      </div>
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <!-- SEARCH BY OPTIONS: ID, PIN, TITLE, FIRSTNAME, LASTNAME, PHONE, EMAIL, SEX. -->
        <div class="x_panel">
          <div class="x_title">
            <h2>ID, PIN, TITLE, FIRSTNAME, LASTNAME, PHONE, EMAIL, SEX. </h2>
          ...
          <div class="x_content">
            <br />
            <form class="form-horizontal form-label-left" id="demo-form2" method="POST" action="{{ route('search_by_option') }}" data-parsley-validate>
                @csrf
              ...
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="search">Search for <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <select class="select2_single form-control" name="search"  tabindex="-1">
            ...
            <form class="form-horizontal form-label-left" id="demo-form2" method="POST" action="{{ route('search_by_option') }}" data-parsley-validate>
              ...
              <div class="form-group">
                ...
                <select class="select2_single form-control" id="value" name="value" required="required"  tabindex="-1">
                    ...
                    <option value="NULL">NO PROVINCE</option>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <select class="select2_single form-control" id="value" name="value" required="required"  tabindex="-1">
                    ...
                    <option value="NULL">NO DIOCESE</option>
                    <option value="ABROAD">ABROAD</option>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <select class="select2_single form-control" id="value" name="value" required="required"  tabindex="-1">
                    ...
                    <option value="NULL">NO COMMITTEE</option>
