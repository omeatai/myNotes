  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3>PRINT BY OPTION: <small></small></h3>
      </div>
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
            <form class="form-horizontal form-label-left" id="demo-form2" method="POST" action="{{ route('print_by_id') }}" data-parsley-validate enctype="multipart/form-data">
                @csrf
                @include('inc.messages')

              <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="ids">ID<span class="required">:</span>
                  </label>
                  <div class="col-md-9 col-sm-9 col-xs-12">
                    <textarea class="form-control" id="ids" name="ids" rows="5" placeholder="List a single ID or all the required Ids (separated by commas ONLY)." required></textarea>
                  </div>
                </div>

              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="search">Print by <span class="required">*</span>
                </label>
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
              <br />
              <form class="form-horizontal form-label-left" id="demo-form2" method="POST" action="{{ route('print_by_pin') }}" data-parsley-validate enctype="multipart/form-data">
                @csrf

                  @include('inc.messages')

                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pins">PIN<span class="required">:</span>
                    </label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <textarea class="form-control" id="pins" name="pins" rows="5" placeholder="List a single PIN or all the required Pins (separated by commas ONLY)." required></textarea>
                    </div>
                  </div>
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
            <form class="form-horizontal form-label-left" id="demo-form2" method="POST" action="{{ route('print_by_province') }}" data-parsley-validate enctype="multipart/form-data">
                @csrf
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
            <form class="form-horizontal form-label-left" id="demo-form2" method="POST" action="{{ route('print_by_diocese') }}" data-parsley-validate enctype="multipart/form-data">
                @csrf
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
            <form class="form-horizontal form-label-left" id="demo-form2" method="POST" action="{{ route('print_by_church') }}" data-parsley-validate enctype="multipart/form-data">
                @csrf
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
            <form class="form-horizontal form-label-left" id="demo-form2" method="POST" action="{{ route('print_by_designation') }}" data-parsley-validate enctype="multipart/form-data">
                @csrf
                @include('inc.messages')
              <div class="form-group">
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
            <form class="form-horizontal form-label-left" id="demo-form2" method="POST" action="{{ route('print_by_committee') }}" data-parsley-validate enctype="multipart/form-data">
                @csrf
                @include('inc.messages')
              <div class="form-group">
