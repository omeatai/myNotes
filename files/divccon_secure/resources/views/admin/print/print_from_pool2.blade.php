  ...
  <div class="container">
        ...
        <table class="table" style="width:100%">
            <thead>
                <tr>
                   <th scope="col">
                    <form action="/confirm_print_pool" method="post">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <button type="submit" class="btn btn-success btn-lg pageButton">CONFIRM PRINT</button>
                        <button type="submit" class="btn btn-warning btn-lg pageButton" formaction="/reset_print_pool">I DID NOT PRINT! (GO BACK)</button>
                    </form>
                    <br/>
