...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <a href="/print_from_notprinted" class="btn btn-warning btn-lg" role="button">REFRESH</a>

        <div class="clearfix"></div>

        <form class="form-horizontal form-label-left" id="demo-form2" method="POST" action="{{ route('print_from_notprinted2') }}" data-parsley-validate enctype="multipart/form-data">
            @csrf
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>PRINT FROM NOT-PRINTED ({{$members_count}} FOUND)</h2>
