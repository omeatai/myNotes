...
<html lang="en">
  <head>
    ...
    <title>PRINT BY DESIGNATION</title>
  ...
  <div class="container">
        ...
        <table class="table" style="width:100%">
            <thead>
                <tr>
                   <th scope="col">
                    <form action="/confirm_print" method="post">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <button type="submit" class="btn btn-success btn-lg pageButton">CONFIRM PRINT</button>
                        <button type="submit" class="btn btn-warning btn-lg pageButton" formaction="/reset_print">I DID NOT PRINT! (GO BACK)</button>
                    </form>
                    <br/>
            ...
            <tbody>
                ...
                <?php if($i%2 === 0) echo '<tr>'; ?>
                   ...
                   <td>
                        ...
                        //IF THE MEMBER HAS NO DIOCESE, SHOW THE PERSON AS SPECIAL GUEST (NON - ANGLICAN)
                        if($diocese == NULL){
                        $diocese = "VISITOR";
