...
<div class="container">
  <main>
    <div class="py-5 text-center">
      ...
      <h2 class="topic">REGISTRATION FORM V - Designation</h2>
      <p class=""><span class="welcome">Awesome!, {{ $title }} {{ $firstname }} {{ $lastname }} </span><br> <span class="topic2">CONTINUE TO FILL THE FORM BELOW:</span></p>
    </div>
    ...
    <div class="row g-5">
      ...
      <div class="col-md-7 col-lg-8">
        ...
        <form method="POST" action="{{ route('registration5') }}">
            @csrf
            <div class="row">
                <div class="col-sm-6">
                    <label for="designation" class="form-label">What is your Designation?</label>
                    <select class="form-select" name="designation" id="designation" required autofocus>
